...
const js_1 = require("@rollup-use/js");
...
const outDir = "dist";
const outputName = js_1.resolveOutputName(pkg.name); // the built file name is outDir/outputName.format.js. You can modify it.
const moduleName = js_1.resolveModuleName(pkg.name); // for umd, amd. You can modify it.
...
const external = [...js_1.resolveAllDependencies(pkg)];
const umdExternal = [...js_1.resolveUMDDependencies(pkg)]; // umd should bundle dependencies
...
exports.default = [
    ...
    {
        input,
        external: (source) => js_1.belongsTo(source, external),
    ...
    {
        input,
        external: (source) => js_1.belongsTo(source, umdExternal),
